...
public class IsoceleceTriangle extends Triangle {
    ...
    public boolean pointInShape(Point point) {
        ...
        Line oddSide = side1.distance.divide(new BigDecimal(1), new MathContext(EQUALITY_PRECISION))
                .equals(side2.distance.divide(new BigDecimal(1), new MathContext(EQUALITY_PRECISION))
                ) ? side3 : side2.distance.divide(new BigDecimal(1), new MathContext(EQUALITY_PRECISION))
                .equals(side3.distance.divide(new BigDecimal(1), new MathContext(EQUALITY_PRECISION))
                ) ? side1 : side3.distance.divide(new BigDecimal(1), new MathContext(EQUALITY_PRECISION))
                .equals(side1.distance.divide(new BigDecimal(1), new MathContext(EQUALITY_PRECISION))
                ) ? side2 : null;
        ...
        if (modpoints[indexOfTopPoint].yCoordinate.divide(new BigDecimal(1), new MathContext(EQUALITY_PRECISION)).compareTo(new BigDecimal(0)) <= 0) {
            for (int i = 0; i < modpoints.length; i++) {
